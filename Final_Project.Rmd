...
clean <- clean[!is.na(clean$YardsToGoal),]

# Useful exercise in accomodating NAs for stadium type
summary(clean$StadiumTypeNew)
levels(clean$StadiumTypeNew)
levels(clean$StadiumTypeNew) <- c(levels(clean$StadiumTypeNew),"Unknown")
levels(clean$StadiumTypeNew)
clean[is.na(clean$StadiumTypeNew),which(colnames(clean)=="StadiumTypeNew")] <- "Unknown"
summary(clean$StadiumTypeNew)
