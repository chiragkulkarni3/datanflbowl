...
# For whatever reason, this works fine for visiting teams but leads to 747 NAs for the home team when coercing in the case of Arizona
...
df$Point_Diff <- ifelse(df$PossessionTeam==df$VisitorTeamAbbr,df$VisitorScoreBeforePlay-df$HomeScoreBeforePlay,df$HomeScoreBeforePlay-df$VisitorScoreBeforePlay)
...
# note: do not consider X and Y in these models 
