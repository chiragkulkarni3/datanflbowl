...
bintrain <- clean[,binbest]
bintrain <- bintrain[complete.cases(btrain),]
...
boost<-boosting(Yards ~ ___, 
                 data=train,boos=F,mfinal=20)
#boost.class
predboost <- predict(boost, newdata=train_prepared, 
